    ...
    <s.LocationWrapper style={{ backgroundColor: '#27272A' }} >
      ...
      <s.LocationGrid>
        <s.LocationCard>
          ...
          />
          <s.LocationName>{t('homePage.locationSection.locations.hcm')}</s.LocationName>
        </s.LocationCard>
        ...
        <s.LocationCard>
          <s.LocationImage
            ...
            alt="Hanoi"
          />
          <s.LocationName>{t('homePage.locationSection.locations.hanoi')}</s.LocationName>
        </s.LocationCard>
        ...
        <s.LocationCard>
          <s.LocationImage
            ...
            alt="Da Lat"
          />
          <s.LocationName>{t('homePage.locationSection.locations.dalat')}</s.LocationName>
        </s.LocationCard>
        ...
        <s.LocationCard>
          <s.LocationImage
            ...
            alt="Other Locations"
          />
          <s.LocationName>{t('homePage.locationSection.locations.other')}</s.LocationName>
        </s.LocationCard>
      </s.LocationGrid>
    </s.LocationWrapper>
  );
